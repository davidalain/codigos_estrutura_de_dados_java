...
public class MyArrayListOrdenado<T extends Comparable<T>> {
	...
	public static void main(String[] args) {
		...
		MyArrayListOrdenado<Integer> lista = new MyArrayListOrdenado<>(20);
		lista.imprimirLista();
	...
	public MyArrayListOrdenado(int quantidade){
		conteudo = (T[]) new Comparable[quantidade];
		tamanho = 0;
	}

	public Comparable<T> pegar(int indice){
		if(indice >= tamanho){
